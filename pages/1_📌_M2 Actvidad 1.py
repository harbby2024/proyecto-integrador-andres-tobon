...
info_libros ={"Titulo": ["Harry Potter y la piedra filosofa", "Lucky boy", "Atravez de ti","La Riqueza de las naciones"]}, { "Autor": ["J. K. Rowling", "Shanthi Sekeran", "Ariana Godoy", "Adam Smith "] }, { "Año de publicación":[2000, 2017, 2021, 1992] }, {"Genero":["Ficción", "Drama" , "Romantica" , "Política" ]},
...
st.dataframe(df_poblacion_ciudades.info)
